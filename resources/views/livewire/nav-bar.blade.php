        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a wire:navigate class="nav-link {{ Request::is('datasiswa') ? 'active' : '' }}" href="/datasiswa" style="color: #6200ea; font-weight: 500; padding: 10px 15px; border-radius: 4px; transition: background-color 0.3s, box-shadow 0.3s;">
                            Data Siswa
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('users') ? 'active' : '' }}" href="/users" style="color: #6200ea; font-weight: 500; padding: 10px 15px; border-radius: 4px; transition: background-color 0.3s, box-shadow 0.3s;">
                            User Admin
                        </a>
                    </li>
                </ul>

                <button wire:click="logout" class="btn btn-primary ms-lg-3 ripple" style="border-radius: 25px; background-color: #6200ea; color: white; font-weight: bold; padding: 10px 20px; box-shadow: 0 3px 5px rgba(0, 0, 0, 0.2);">
